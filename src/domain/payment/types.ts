...
export const PaymentStatus = Schema.Literals(["pending", "processing", "succeeded", "failed"]);
...
export class PaymentNotFound extends Schema.TaggedErrorClass<PaymentNotFound>()("PaymentNotFound", {
  id: PaymentId,
}) {}
