 ...
 */
export const validateAmount = Effect.fn("validateAmount")(function* (money) {
 ...
 */
export const processPayment = Effect.fn("processPayment")(function* (payment) {
